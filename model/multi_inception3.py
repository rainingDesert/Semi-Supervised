...
def get_inception3_model(pretrained=True, **kwargs):
...
class Inception3(nn.Module):
    ...
    def __init__(self, args=None, inference=False):
        ...
        self.cls1 = self.classifier(288, self.class_nums)
        self.cls2 = self.classifier(768, self.class_nums)
        self.cls3 = self.classifier(768, self.class_nums)
